...
<NavLinks  >
    ...
    <StyledNavLink showmenu={showmenu} to="/"> < Dashboard showmenu={showmenu}></Dashboard>  <NavLinkText>داشبورد</NavLinkText></StyledNavLink>
        <StyledNavLink showmenu={showmenu} to="/دسته بندی محصولات"> < NavLinkProduct showmenu={showmenu}></NavLinkProduct>  <NavLinkText>دسته بندی محصولات</NavLinkText></StyledNavLink>
