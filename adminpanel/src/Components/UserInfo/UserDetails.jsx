...
//       try {
//         const response = await axios.get(`http://91.107.160.88:3001/v1/admin/user/${userId}`);
...
function UserDetails() {
  ...
  const accessToken =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0ZDM2ZTliYjZkMWQ4OTE0MDRhN2VmMSIsImlhdCI6MTY5MTU4ODIxNSwiZXhwIjoxNjk1MTg4MjE1fQ.5yPCSQ9GmsziW-PXXDt1ibYo7Zd-u_3gCn3AKwp8AIQ";
